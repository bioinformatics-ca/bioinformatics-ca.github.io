...
biom convert --to-tsv -i clustering/otu\_table\_high\_conf.biom --table-type='OTU table' -o clustering/otu\_table\_high\_conf.tsv --header-key=taxonomy --output-metadata-id=Consensus\\ Lineage
